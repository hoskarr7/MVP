...
import { CajaDestinoModal } from '../components/CajaDestinoModal';

export class ComprobanteCobroFormPage extends BasePage {
  ...
  readonly cajaDestino = new CajaDestinoModal(this.page);
