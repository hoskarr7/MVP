Feature: OVE-64535 - Generación de Asientos Contables a cargo del orquestador en Pagos
  ...
  Scenario: Crear una Orden de Pago con imputaciones incompletas debe ser rechazada (Escenario 5 AC)
    ...
    Then el guardado del comprobante de pago es rechazado por falta de imputaciones contables
