Feature: OVE-57603 - Generación de Asientos Contables a cargo del orquestador
  ...
  Scenario: Crear una Nota de Credito Articulos no debe llamar a la API de Asientos Contables desde el front
    ...
    And selecciona el tipo de comprobante "Nota de Credito Articulos"
    And completa el número "9983"
    And busca y selecciona el socio de negocio "BH"
    And selecciona la segunda opción de centro de costos
    And aplica el descuento o recargo general "Descuento 10%"
    ...
    And no debe haberse generado ningún asiento contable en la base de datos
