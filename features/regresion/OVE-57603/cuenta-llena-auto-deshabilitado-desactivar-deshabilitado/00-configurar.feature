Feature: OVE-57603 - Configuración: Cuenta Deudora llena + Auto Deshabilitado + Desactivar Asientos en Borrador deshabilitado
  ...
  Scenario: Configurar la aplicación con Cuenta Deudora llena, Asiento Automático deshabilitado y Desactivar Asientos en Borrador deshabilitado
