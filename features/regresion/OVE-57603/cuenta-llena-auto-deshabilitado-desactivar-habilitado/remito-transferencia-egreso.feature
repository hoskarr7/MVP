Feature: OVE-57603 - Generación de Asientos Contables a cargo del orquestador
  ...
  Scenario: Crear un Remito Transferencia Egreso no debe llamar a la API de Asientos Contables desde el front
    ...
    And selecciona el tipo de comprobante "Remito Transferencia Egreso"
    And selecciona la sucursal destino
