Feature: OVE-57603 - Configuración: Cuenta Deudora limpia + Auto Deshabilitado + Desactivar Asientos en Borrador deshabilitado
  ...
  Scenario: Configurar la aplicación con Cuenta Deudora limpia, Asiento Automático deshabilitado y Desactivar Asientos en Borrador deshabilitado
