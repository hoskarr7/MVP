Feature: OVE-57603 - Generación de Asientos Contables a cargo del orquestador
  ...
  Scenario: Crear una Factura de venta Articulos - Afecta Stock no debe llamar a la API de Asientos Contables desde el front
    ...
    And aplica el descuento o recargo del item "Descuento Item"
