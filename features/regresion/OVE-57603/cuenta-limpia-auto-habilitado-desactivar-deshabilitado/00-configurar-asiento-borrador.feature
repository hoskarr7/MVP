Feature: OVE-57603 - Configuración de parametrización para Asiento Contable en Borrador
  ...
  Scenario: Configurar la aplicación para que los Asientos Contables se generen en Borrador
